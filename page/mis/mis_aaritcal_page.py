...
class MisAtcalPage(BasePage):
    def __init__(self):
        ...
        # 查询按钮
        self.query_btn = (By.CSS_SELECTOR, "[placeholder*='频']")
        # 通过按钮
...
class MisAtcalHandle(BaseHandle):
    ...
    # 驳回按钮点击
    def click_rej_btn(self):
        self.mis_atcal_page.find_rej_btn().click()
